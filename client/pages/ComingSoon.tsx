...
export default function ComingSoon({ title, description }: ComingSoonProps) {
  ...
  const getPageDescription = () => {
    ...
    const pathMap: Record<string, string> = {
      "/company/artist":
        "Information about our talented artists and their achievements",
      "/company/business":
        "Details about our business operations and strategies",
      "/company/ethical":
        "Our commitment to ethical business practices and corporate responsibility",
